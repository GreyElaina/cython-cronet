...
cdef extern from ".h" nogil:
    ...
    cdef struct stream_engine:
        void * obj
        void * annotation

    cdef struct bidirectional_stream:
        void * obj
        void * annotation

    cdef struct bidirectional_stream_header:
        const char * key
        const char * value

    cdef struct bidirectional_stream_header_array:
        size_t count
        size_t capacity
        bidirectional_stream_header * headers

    cdef struct bidirectional_stream_callback:
